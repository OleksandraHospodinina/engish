...
function moveSlide(direction) {
  ...
  indicators[Math.floor(currentSlide / 2)].classList.remove(
  ...
  slides[(currentSlide + 1) % totalSlides].classList.add(
    "reviews__slide--active"
  );
  indicators[Math.floor(currentSlide / 2)].classList.add(
    "reviews__indicator--active"
  );
}
...
function moveToSlide(index) {
  ...
  slides[currentSlide].classList.add("reviews__slide--active");
  slides[(currentSlide + 1) % slides.length].classList.add(
    "reviews__slide--active"
  );
